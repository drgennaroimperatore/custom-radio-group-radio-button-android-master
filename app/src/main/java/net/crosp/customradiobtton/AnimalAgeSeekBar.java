...
public class AnimalAgeSeekBar extends LinearLayout {
...
public AnimalAgeSeekBar (Context context, AttributeSet attributeSet) {

    super(context, attributeSet);
}

    public AnimalAgeSeekBar (Context context) {
    ...
    protected void onFinishInflate() {
        ...
        getActivity().getLayoutInflater()
                .inflate(R.layout.animal_age_seekbar, this);
    }
    ...
    private TextView createInterval(String interval) {
        View textBoxView = (View) LayoutInflater.from(getContext())
                .inflate(R.layout.animal_age_seekbar_labels, null);
